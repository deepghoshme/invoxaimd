  ...
  const Foot = () => {
    ...
    return (
      <div className="sfoot">
        ...
        <div className="cop" style={{ justifyContent: "center", paddingTop: 0 }}><a href="https://app.invoxai.io/account" target="_blank" rel="noreferrer" style={{ fontSize: 12, opacity: .6 }}>My orders &amp; account ↗</a></div>
      </div>
    );
  };
